    ...
    <footer className="footer" id="contact">
            ...
            <div className="container footer__inner">
                ...
                <div className="footer__brand">
                    ...
                    <div className="footer__socials">
                        {[
                            { id: 'instagram', url: 'https://www.instagram.com/dropy_hub?igsh=NWJ3dXRma2d5OW5n' },
                            { id: 'twitter', url: '#' },
                            { id: 'linkedin', url: '#' },
                            { id: 'youtube', url: '#' }
                        ].map(s => (
                            <a key={s.id} href={s.url} target={s.url !== '#' ? "_blank" : "_self"} rel={s.url !== '#' ? "noopener noreferrer" : ""} className="footer__social" aria-label={s.id}>
        ...
        <div className="footer__bottom">
            <div className="container footer__bottom-inner">
                <span>© 2025 DropyHub. All rights reserved.</span>
